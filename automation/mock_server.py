...
BILINGUAL_SCRIPT = {
    ...
    "segments": [
        ...
        {"type": "problem", "start": 4, "end": 8,
         "narration": "ज़्यादातर लोग इसे सिर्फ एक नंबर समझते हैं, और यहीं गलती होती है। आपके साथ भी ऐसा हुआ है?",
         "visual": "broll", "broll_prompt": "Indian stock exchange screen with falling numbers, confused young investor",
         "emotion": "concerned",
         "subtitle_text": "Most people see it as just a number - and that is the mistake. Has it happened to you too?"},
        {"type": "solution", "start": 8, "end": 15,
         "narration": "Meri ek dost har subah NIFTY dekh ke ghabra jaati thi. Phir usne samjha - NIFTY is simply a scoreboard of India's 50 biggest companies.",
         "visual": "actor_talking", "broll_prompt": None, "emotion": "confident",
         "subtitle_text": "A friend of mine used to panic every morning watching NIFTY. Then she learned it is just a scoreboard of India's 50 biggest companies."},
        ...
        {"type": "cta", "start": 19, "end": 21,
         "narration": "Follow for one market concept every day. Comment YES if this helped you?",
         "visual": "actor_talking", "broll_prompt": None, "emotion": "friendly",
         "subtitle_text": "रोज़ एक मार्केट कॉन्सेप्ट के लिए फॉलो करें। मदद मिली तो YES कमेंट करें?"},
    ],
